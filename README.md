...
(con)template agent: The assessment manager that administers Tau-Bench evaluations (https://github.com/christian-templeton/contempletiva-agent)
...
(pro)active agent: The target agent being tested
